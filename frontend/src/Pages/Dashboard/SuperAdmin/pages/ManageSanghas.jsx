...
import CreateSanghaModal from "../Modal/CreateSanghaModal";
import EditSanghaModal from "../Modal/EditSanghaModal";
    ...
    <div className="sa-page">
      <div className="sa-section__header">
        ...
        <div className="sa-search">
          <svg className="sa-search__icon" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
